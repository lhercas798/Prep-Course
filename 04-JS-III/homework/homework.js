...
function empiezaConNueve(n) {
  ...
  if (numero.charAt(0)=="9"){return true;}
  return false;
...
function mesesDelAño(array) {
  ...
  var arreglo=[];
  for (var i=0; i <= array.length; i++){
    if(array[i]==="Enero" || array[i]==="Marzo" || array[i]==="Noviembre"){arreglo.push(array[i]);
...
function breakStatement(numero) {
  ...
  for (var i=0; i<10; i++){
    numero = numero+2;
    array.push(numero);
    if (array[i]==i){return "Se interrumpió la ejecución";break;}
